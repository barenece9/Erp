...
import com.lnsel.erp.fragment.NoticeFragment;
import com.lnsel.erp.fragment.PayslipFragment;
import com.lnsel.erp.other.CircleTransform;
...
public class HomeScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(HomeScreen.this, ApplyLeaveActivity.class));
    ...
    private void loadNavHeader() {
        // name, website
        UserInfo rememberData= Sharepreferences.getUserinfo(HomeScreen.this);
